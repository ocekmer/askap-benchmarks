...
void OpenMP::findPeak(const vector<float>& image, float& maxVal, size_t& maxPos)
{
	maxVal = 0.0;
	maxPos = 0;
...
void OpenMP::subtractPSF(const size_t peakPos,
...
OpenMP::Position OpenMP::idxToPos(const int idx, const size_t width)
{
...
size_t OpenMP::posToIdx(const size_t width, const OpenMP::Position& pos)
{
	return (pos.y * width) + pos.x;
}

void OpenMP::deconvolve()
{
