...
void OpenMPNew::findPeak(const vector<float>& image, float& maxVal, size_t& maxPos)
{
	maxVal = 0.0;
	maxPos = 0;
...
void OpenMPNew::subtractPSF(const size_t peakPos,
...
OpenMPNew::Position OpenMPNew::idxToPos(const int idx, const size_t width)
{
...
size_t OpenMPNew::posToIdx(const size_t width, const OpenMPNew::Position& pos)
{
	return (pos.y * width) + pos.x;
}

void OpenMPNew::deconvolve()
{
